...
Salah satu tantangan utama dalam pengelolaan sampah pada tingkat operasional adalah pengangkutan yang masih dilakukan berdasarkan jadwal tetap, tanpa mempertimbangkan kondisi aktual kepenuhan tempat sampah. Akibatnya, tempat sampah yang masih kosong tetap didatangi dan diperiksa, sementara tempat sampah yang sudah penuh berpotensi terlambat ditangani. Praktik ini terjadi karena tidak tersedianya informasi mengenai kondisi tempat sampah secara berkala; satu-satunya cara mengetahui kondisi adalah dengan pengecekan visual langsung ke lokasi. Ketiadaan informasi ini diperparah oleh ketiadaan data historis yang terstruktur mengenai pola pembuangan. Pertanyaan seperti kapan terjadi puncak pembuangan, apakah ada perbedaan pola antara hari kerja dan akhir pekan, serta jenis sampah apa yang mendominasi, menjadi sulit dijawab. Tanpa data tersebut, jadwal pengangkutan tidak dapat dioptimalkan dan pengambilan keputusan pengelolaan dilakukan tanpa basis data.
...
Berdasarkan permasalahan tersebut, penelitian ini bertujuan untuk mengembangkan sistem pemantauan sampah berbasis \textit{Internet of Things} (IoT) yang disesuaikan dengan kebutuhan lingkungan kampus, baik dari sisi perangkat lunak sistem maupun \textit{firmware} perangkat. Sistem yang dibangun kemudian diuji di Gedung Labtek VIII ITB untuk mengumpulkan data pembuangan sampah, yang selanjutnya dianalisis untuk mengidentifikasi pola pembuangan yang dihasilkan.
...
\begin{enumerate}
    \item Bagaimana rancangan dan implementasi sistem pemantauan sampah berbasis \textit{Internet of Things} (IoT) yang mampu mengumpulkan data pembuangan sampah secara periodik dan terstruktur?
...
Penelitian ini bertujuan untuk merancang dan mengimplementasikan sistem pemantauan sampah berbasis \textit{Internet of Things} untuk memahami pola pembuangan sampah di Gedung Labtek VIII ITB. Secara detil, tujuan penelitian ini adalah:

\begin{enumerate}
    \item Merancang arsitektur dan mengimplementasikan sistem pemantauan sampah berbasis \textit{Internet of Things} (IoT) yang mampu mengumpulkan data pembuangan sampah secara periodik dan terstruktur.
...
\begin{enumerate}
    ...
    Fase ini bertujuan untuk merancang dan membangun artefak sistem pemantauan sampah berbasis \textit{Internet of Things} berdasarkan kebutuhan yang telah ditetapkan. Aktivitas pada fase ini meliputi:
    \begin{enumerate}[a.]
...
\begin{enumerate}
    ...
    \item Bab III Analisis: Berisi penjelasan tentang analisis kebutuhan pengguna dan sistem, termasuk pendefinisian kebutuhan fungsional dan nonfungsional sistem pemantauan sampah berbasis \textit{Internet of Things}.
    ...
    \item Bab VI Evaluasi: Berisi analisis dan evaluasi terhadap sistem yang diimplementasikan, mencakup pengujian kebutuhan fungsional dan nonfungsional, analisis pola pembuangan sampah, serta evaluasi adaptasi \textit{firmware}.
